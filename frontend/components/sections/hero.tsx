    ...
    <section className="relative min-h-screen flex flex-col overflow-hidden">
        ...
        >
            <div className="text-center space-y-8 px-4">
                {/* Main Headline */}
                <h1 className="text-4xl md:text-7xl font-bold text-white inter-var">
                ...
                {/* Subheadline */}
                <p className="text-base md:text-xl text-white/80 max-w-2xl mx-auto font-normal inter-var">
                ...
                {/* Trust Indicators */}
                <div className="flex flex-wrap justify-center gap-8 pt-12 text-sm text-white/60">
